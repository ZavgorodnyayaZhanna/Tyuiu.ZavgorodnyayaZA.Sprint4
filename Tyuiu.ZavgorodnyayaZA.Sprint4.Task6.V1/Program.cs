...
using Tyuiu.ZavgorodnyayaZA.Sprint4.Task6.V1.Lib;
namespace Tyuiu.ZavgorodnyayaZA.Sprint4.Task6.V1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Title = "Спринт #4 | Выполнила: Завгородняя Ж. А. | ИCПб-23-1";
            Console.WriteLine("***************************************************************************");
